...
import { SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View, TouchableWithoutFeedback } from 'react-native'
        ...
        <View style={styles.content}>
            ...
            <View style={{ marginTop: 40 }}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <Text style={{ marginBottom: 20, color: '#fff', fontFamily: 'Rubik_700Bold', fontSize: 32 }}>Joined Spaces</Text>
